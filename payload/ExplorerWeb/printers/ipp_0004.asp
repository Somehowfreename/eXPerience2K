...
Dim strDevice, strPortname, strModel
...
End Sub
    ...
    if Len(strEncodedPrinter) > MAX_ENCODED_PRINTER_NAME_LENGTH Then Call ErrorHandler(L_Invalid_Parameter)
...
<%
    ...
    strTitle = RepString2(L_Title_Text, GetFriendlyName (objQueue.PrinterName, session(COMPUTER)), session(LOCAL_SERVER) )
    strLeftPaneUrl = "ipp_0005.asp?eprinter=" & strEncodedPrinter & VIEW_EQUALS & strView & ATURLPRINTER & strURLPrinter
